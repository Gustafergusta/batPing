...
call :cor 20 "ABRINDO CONEXAO PARA VERIFICAR PABX"
start mstsc /v:192.168.0.9 /admin > nul 2>&1
...
rem Executa o SERVIDOR PROXMOX
ping -n 2 -w 1 192.168.0.6 > nul
if %errorlevel%==0 (
    call :cor 20 "SERVIDOR PROXMOX .6 - Okay."
) else (
    call :cor 40 "SERVIDOR PROXMOX .6 - Falha no ping."
)
...
if %errorlevel%==0 (
    call :cor 20 "DVR ADM 1.100 - Okay."
) else (
    call :cor 40 "DVR ADM .1.100 - Falha no ping."
)
